...
class ParseAddrObjects extends AbstractGarParserCommand
{
     ...
     * @var string
     */
    protected $signature = 'gar:parse:add-objects {date : Дата выгрузки} {region=all : Регион для парсинга. Базово парсит все}';
     ...
     */
    protected $fileNamePattern = '~AS_ADDR_OBJ_\d+?.+?\.xml~i';
